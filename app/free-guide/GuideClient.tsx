...
const CHAPTERS = [
  ...
  { n:"03", title:"What Automation Actually Delivers", desc:"6 documented stats with sources. Real numbers, no projections." },
      ...
      <section style={{ padding:"72px 5vw", maxWidth:1200, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:56 }}>
          ...
          <p style={{ fontSize:17, color:"rgba(245,240,232,0.5)", maxWidth:640, margin:"0 auto", lineHeight:1.7 }}>
            Most businesses start with chatbots and call it a day. The ones winning are finding leverage in places their competitors haven't looked. Here is the list.
          </p>
        </div>
